...
public class TempScript : MonoBehaviourPunCallbacks
{
    ...
    private void Move()
    {
        ...
        PV.RPC("setWorldVelocity", RpcTarget.AllBuffered);
        PV.RPC("setRSpeed", RpcTarget.AllBuffered);
