...
public class PlayerController : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        if (GetComponentInChildren<AnimateWalk>())
            animateWalk = GetComponentInChildren<AnimateWalk>();
    ...
    void UpdateWalk()
    {
        if (animateWalk == null) return;
        animateWalk.setWalking(isWalking());
        animateWalk.setSprinting(isSprinting());
    }
