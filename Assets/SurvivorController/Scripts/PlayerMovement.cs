...
{
    public float walkSpeed = 64.0f;
    public float runSpeed = 128.0f;
    ...
    public readonly float VELOCITY_RESET = -1f;
    ...
    public void UpdateJump()
    {
        if (jump != Vector3.zero)
        {
            ...
            jumpPower = Mathf.Max(move.magnitude, jumpSpeed);
    ...
    void resetVelocity()
    {
        ...
        {
            moveDirection.y = VELOCITY_RESET;
        }
    }
